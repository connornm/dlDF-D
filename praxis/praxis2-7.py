#! /usr/bin/env python
#
# Connor Dolan: Added copy function since origianl .copy() is only available for python3.3+
# If python3.3+ is used remove below line and revert comments back to original VVVVV
...
#  Connor Dolan: Previous code above. Does not work in Python 2.7.5. Faithfully replaced with a loop:
#  for i in range(n):
