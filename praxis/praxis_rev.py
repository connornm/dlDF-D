...
def praxis ( t0, h0, n, prin, x, f , load=False, fstr='praxis_cache'):
...
#
  ...
  if load:
    x,scbd,illc,ktm,ldfac,kt,nl,nf,fx,qf1,t,t2,dmin,h,ldt,v,d,y,z,qa,qb,qc,qd0,qd1,q0,q1=pickle.load(open('.save/'+fstr, 'wb'))
################################################VVV NORMAL#########################
  else:
    scbd = 1.0
    illc = False
...
#
  while ( True ):
    ...
    pickle.dump([x,scbd,illc,ktm,ldfac,kt,nl,nf,fx,qf1,t,t2,dmin,h,ldt,v,d,y,z,qa,qb,qc,qd0,qd1,q0,q1],open('.save/'+fstr, 'wb'))
